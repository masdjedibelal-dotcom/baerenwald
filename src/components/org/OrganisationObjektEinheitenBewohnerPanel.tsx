...
export function OrganisationObjektEinheitenBewohnerPanel({ objektId }: { objektId: string }) {
  ...
  return (
    <div className="space-y-6">
      <OrganisationObjektEinheitenPanel objektId={objektId} embedded onEinheitenChange={loadEinheiten} />

      <div className="space-y-3 border-t border-border-light pt-4">
        <p className="text-sm font-semibold text-text-primary">Bewohner (nur intern)</p>
