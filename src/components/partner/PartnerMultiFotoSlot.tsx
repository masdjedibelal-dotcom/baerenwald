...
/**
 * Foto-Slot mit bis zu 5 Fotos — kleine Vorschau-Row darunter.
 * Mobil: Kamera; Desktop: Mediathek / Foto hochladen.
 */
export function PartnerMultiFotoSlot({
  ...
  async function onPick(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setError(
        isMobile
          ? "Foto konnte nicht verarbeitet werden. Bitte erneut aufnehmen."
          : "Foto konnte nicht verarbeitet werden. Bitte erneut wählen."
      );
    }
  }
  ...
  const ctaLabel = isMobile ? "Kamera öffnen" : "Foto hochladen";
