/** Firmensitz-Felder Handwerker — Portal ↔ CRM. */
...
/** „Musterstraße 12a“ → Straße + Hausnummer. */
...
/** Legacy-Zeile „Straße Nr, PLZ Ort“. */
...
/**
 * Anzeige-/Edit-Werte aus DB inkl. Legacy-Fallbacks
 * (strasse enthält Nr., ort enthält PLZ, oder nur `adresse`).
 */
