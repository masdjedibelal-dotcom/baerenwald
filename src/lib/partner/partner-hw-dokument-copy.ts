...
export const PARTNER_HW_DOKUMENT_TYPEN_KURZ =
  "Angebot, Rechnung, Protokoll, Dokumentation oder Sonstiges";

export const PARTNER_HW_DOKUMENT_UPLOAD_LABEL = "PDF hochladen (optional)";
...
export function partnerHwDokumentUploadHint(opts?: {
  ...
  return `${PARTNER_HW_DOKUMENT_TYPEN_KURZ} — max. ${maxBatch} PDFs pro Upload, insgesamt ${maxGesamt}. Je ${PARTNER_MAX_PDF_MB} MB. ${PARTNER_HW_DOKUMENT_NUR_CRM}`;
}
