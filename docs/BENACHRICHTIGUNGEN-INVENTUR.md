...
**Status:** Freigabe ausstehend — **kein** `notify()`-Dienst, keine Glocken-Vereinheitlichung, keine Pref-UI bis Belal freigibt.  
**Verwandt:** [DOKUMENTE-MAIL-INVENTUR.md](./DOKUMENTE-MAIL-INVENTUR.md) (Mail-Layout), [COPY-REGELN.md](./COPY-REGELN.md).

---

## Ziel (Phasen B–D, nach Freigabe)
